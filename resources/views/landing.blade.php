<x-front-layout>
    <!-- Hero -->
    <section class="container relative pb-[100px] pt-[30px] bg-background">
        <div class="flex flex-col items-center justify-center gap-[30px] bg-background">
            <!-- Preview Image -->
            <div class="relative">
                <div class="absolute z-0 hidden lg:block">
                    <div class="font-extrabold text-[220px] text-text_white tracking-[-0.06em] leading-[101%]">
                ...
                <img src="/images/supra.webp" class="w-full max-w-[963px] max-h-[430px] z-10 relative" alt=""
            ...
            <div class="flex flex-col lg:flex-row items-center justify-around lg:gap-[60px] gap-7">
                ...
                <div class="flex items-center gap-y-12">
                    <div class="flex flex-col items-center gap-[2px] px-3 md:px-10" data-aos="fade-left"
                        data-aos-delay="1400">
                        <h6 class="font-bold text-text_black text-xl md:text-[26px] text-center">
                            380
                        </h6>
                        <p class="text-sm font-normal text-center md:text-base text-text_semiblack">
                            Horse Power
                        </p>
                    </div>
    ...
    <!-- Popular Cars -->
    <section class="bg-text_lightgray" id="popularCars">
                ...
                @foreach ($vehicles as $vehicle)
                    ...
                    <div class="card-popular">
                        <div>
                            ...
                            <a href="{{ route('front.detailCatalogue', $vehicle->slug) }}" class="absolute inset-0"></a>
                        </div>
    ...
    <!-- Extra Benefits -->
    <section class="container relative pt-[100px] pb-[100px]">
                ...
                <div class="mt-[50px]">
                    ...
                    <div class="p-1 rounded-full bg-primary group">
                        <a href="#!" class="btn-primary">
                            ...
                            <img src="/svgs/ic-arrow-right.svg"
                                class="transition-all duration-[320ms] opacity-0 group-hover:opacity-100 group-hover:translate-x-3"
                                alt="">
                        </a>
                    </div>
                </div>
    ...
    <!-- FAQ -->
    <section class="bg-text_lightgray container relative py-[100px]">
        <header class="text-center mb-[50px]">
            <h2 class="font-bold text-text_black text-[26px] mb-1">
                Frequently Asked Questions
            </h2>
            <p class="text-base text-text_semiblack">Learn more about Vrom and get a success</p>
        </header>
        ...
        <div class="grid md:grid-cols-2 gap-x-[50px] gap-y-6 max-w-[910px] w-full mx-auto">
            <a href="#!" class="px-6 py-4 border rounded-[24px] border-grey h-min accordion max-w-[430px]"
                id="faq1">
                <div class="flex items-center justify-between gap-1">
                    <p class="text-base font-semibold text-text_black">
                ...
                <div class="hidden pt-4 max-w-[335px]" id="faq1-content">
                    <p class="text-base text-text_black leading-[26px]">
        ...
        <div class="container py-20">
            <div class="flex flex-col">
                <header class="mb-[50px] max-w-[360px] w-full">
                    <h2 class="font-bold text-text_gray text-[26px] mb-4">
                        Drive Yours Today. <br>
                        Drive Faster.
                    </h2>
                    <p class="text-base text-text_gray">Get an instant booking to catch up whatever your
            ...
            <div class="max-w-[800px] absolute xl:bottom-[-40px] right-[0px] lg:max-w-[500px] lg:bottom-[60px] xl:max-w-[800px] max-h-[500px] hidden lg:block">
                ...
                <div class="grid grid-cols-2 gap-y-8 md:grid-cols-4 md:gap-x-12">
                    <div class="flex flex-col gap-y-4">
                        ...
                        <div class="flex flex-col gap-y-2">
                            <a href="" class="text-[14px] lg:text-base text-text_semiblack font-normal hover:text-primary ">
                                Home
                            </a>
                            <a href="" class="text-[14px] lg:text-base text-text_semiblack font-normal hover:text-primary">
                                Catalogs
