            ...
            <div class="flex flex-col gap-y-16 max-w-6xl mx-auto">
                ...
                <div class="flex flex-col gap-y-10 ">
                    ...
                    <div class="flex flex-col gap-y-5 text-center md:flex-row md:justify-between items-center">
                        <p class="text-text_semiblack font-normal lg:text-base"> Terms & Conditions | Privacy Policy
                        </p>
                        <p class="text-text_semiblack font-normal lg:text-base"> Copyright © 2020. All right reserved
                        </p>
                    </div>
                </div>
            </div>
