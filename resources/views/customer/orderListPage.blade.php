        ...
        <div class="container containCatalog gap-12">
            ...
            <div class="my-14">
                ...
                <a href="/orders?status=ongoing"
                    class="{{ Request::get('status') == 'ongoing' ? 'bg-blue-900 text-white font-semibold' : 'font-normal bg-slate-300 hover:bg-blue-800 hover:text-white' }} p-2 rounded-lg m-2">On
                    Going</a>
                            ...
                            <li>
                                <a href="{{ route('front.orderDetail', [$transaction->id]) }}">
                                    <div class="bg-white rounded-3xl p-4">
                                        ...
                                        <img src="{{ $transaction->vehicle->thumbnail }}"
                                            class="rounded-3xl min-w-72 w-full h-48 m-2"
