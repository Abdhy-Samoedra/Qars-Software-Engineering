        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div>
                ...
                <form class="w-full" enctype="multipart/form-data">
                    ...
                    {{-- <img src="{{ str_replace('"', '',Storage::url($vehicle->car_picture)) }}" alt="" class="mx-auto rounded-md w-28"> --}}
                    ...
                    <div class="container flex flex-wrap justify-around w-25 mx-auto">
                        @if ($vehicle->car_picture)
                            @foreach (json_decode($vehicle->car_picture) as $picture)
                                <img src="{{ Storage::url($picture) }}" alt="no img right now" class="w-64 mx-auto mb-5 rounded-md">
                            @endforeach
                        @endif
                    </div>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <input value="{{ old('type') ?? $vehicle->type }}" name="type"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name" type="text" placeholder="Vehicle's Type" required disabled>
                        </div>
                    </div>
