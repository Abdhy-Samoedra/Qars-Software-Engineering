<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            ...
            {!! __('User &raquo; Details &raquo; ') . $user->name !!}
        </h2>
    </x-slot>
                ...
                <form class="w-full" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <input value="{{ old('name') ?? $user->name }}" name="name"
                                ...
                                id="grid-last-name" type="text" placeholder="Name" required disabled>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <input value="{{ old('email') ?? $user->email }}" name="email"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
                                id="grid-last-name" type="text" placeholder="Email" required disabled>
                        </div>
                    </div>
                    ...
                    @if(!empty($user->driving_license_path))
                        <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                            <div class="w-full">
                                ...
                                <img src="{{ str_replace('"', '',Storage::url($user->driving_license_path)) }}" alt="" class="rounded-md w-80 object-left">
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <select name="driving_license_status" required disabled
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500">
