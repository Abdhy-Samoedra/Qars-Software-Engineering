<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">
            ...
            {!! __('Vehicle Category &raquo; Create') !!}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form class="w-full" action="{{ route('admin.vehicleCategories.store') }}" method="post"
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <input value="{{ old('vehicle_category_name') }}" name="vehicle_category_name"
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <input value="{{ old('vehicle_category_description') }}" name="vehicle_category_description"
                                class="block w-full px-4 py-3 leading-tight text-gray-700 bg-gray-200 border border-gray-200 rounded appearance-none focus:outline-none focus:bg-white focus:border-gray-500"
